              ...
              Center(
                ...
                BlocBuilder<ImagePickerBloc, ImagePickerState>(builder: (context, state) {
                  return state.file == null
                      ...
                      : ClipRRect(borderRadius: BorderRadius.circular(60.0), child: Image.file(File(state.file!.path), height: 120, width: 120, fit: BoxFit.cover));
                }),
                Positioned(
                    right: 0,
                    bottom: 0,
                    child: Container(
                        width: 40,
                        height: 40,
                        decoration: BoxDecoration(shape: BoxShape.circle, color: Colors.white, border: Border.all(color: primaryColor)),
                        child: IconButton(
                            onPressed: () {
